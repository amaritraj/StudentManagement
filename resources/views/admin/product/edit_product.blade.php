          ...
          <div class="col-md-12 grid-margin">
            <div class="card rounded">
              <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    <div class="ms-2">
                        <a href="{{ route('product.index') }}" class="btn btn-primary">Edit Product </a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="card-body">
                ...
                <form action="{{ route('update.product', $product->id) }}" method="POST"  class="forms-sample"" enctype="multipart/form-data">
                    @csrf
